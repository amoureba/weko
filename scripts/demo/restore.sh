...
#docker-compose exec postgresql psql -v ON_ERROR_STOP=1 -U invenio1 -d invenio1 -f weko.sql
docker-compose exec postgresql psql -U invenio1 -d invenio1 -f weko.sql
docker cp ${BACKUPDIR}/postgresql/weko2.sql $(docker-compose ps -q postgresql):/
docker-compose exec postgresql psql -U invenio2 -d invenio2 -f weko2.sql
