...
docker-compose exec postgresql pg_dump -U invenio1 -a -f weko.sql -T alembic_version
docker cp $(docker-compose ps -q postgresql):/weko.sql ${BACKUPDIR}/postgresql/
docker-compose exec postgresql pg_dump -U invenio2 -a -f weko2.sql -T alembic_version
docker cp $(docker-compose ps -q postgresql):/weko2.sql ${BACKUPDIR}/postgresql/
